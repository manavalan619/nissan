...
export class LoginService {
  ...
  Logout(user: any): Observable<any> {
    return this.http.post(this.sharedService.DESKTOP_API + '/logout', user);
  }
  ...
  getLoginUserId(id:String) {
    return this.http.get(this.sharedService.DESKTOP_API + `/getuser/${id}`);
  }
